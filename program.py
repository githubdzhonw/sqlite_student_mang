...
class Student:
    def __init__(self, root):
        ...
        def searchDatabase():
            studentlist.delete(0, END)
            for row in stdDatabase_Backend.searchData(StdID.get(), Firstname.get(),
        ...
        DataFrameLEFT = LabelFrame(DataFrame, bd=1, width=1000, height=600, padx=28, bg="Ghost White", relief=RIDGE,
        ...
        self.btnUpdateData = Button(ButtonFrame, text="Update", font=('arial', 20, 'bold'), height=1, width=10, bd=4, command=UpdateData)
